    ...
    <div className="dashboard-helpseeker-container">
      <div className="dashboard-menu-container">
        <div className="dashboard-menu-desktop">
          <DashboardHelpSeekerMenu mode="vertical" menuKey={menuKey} setMenuKey={setMenuKey} />
        </div>
        <div className="dashboard-menu-mobile">
          <DashboardHelpSeekerMenu mode="horizontal" menuKey={menuKey} setMenuKey={setMenuKey} />
        </div>
      </div>
      {menuKey == 'request-1' && (
