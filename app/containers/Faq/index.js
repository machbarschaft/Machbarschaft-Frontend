    ...
    <div className="overflow-scroll content-container-default">
      <div className="imprint-text">
        ...
        <div>
          ...
          einsehen. Sobald du dich entschieden hast, den Auftrag anzunehmen,
          wird die Telefonnummer des oder der Hilfesuchenden angezeigt. Rufe die
          Person an und kläre den genauen Bedarf, den Zeitrahmen und die
          Bezahlmethode. Gib uns Bescheid, sobald du unterwegs bist, und die
          hilfesuchende Person wird automatisch von uns darüber informiert.
          <br />
        ...
        <div>
          ...
          kannst du auch die Bezahlung individuell arrangieren (Bezahlung im
          Voraus oder erst nach deiner Hilfeleistung? In Bar oder andere
          Bezahlmethode?). Um volle Transparenz zu gewährleisten, bitten wir
          dich darum, den Kassenzettel aufzubewahren. Bei der Übergabe der Ware
          sowie bei der Bezahlung gilt, Körperkontakt bitte zu vermeiden! Halte
          den Mindestabstand von 1m bis 2m ein, indem du deine Einkäufe an der
          Wohnungstür abstellst. Das Bargeld soll dir in einem Briefumschlag
        ...
        <div>
          ...
          gerne ablehnen, sodass sie wieder in den Anfragenpool aufgenommen
          wird.
        </div>
        <br />
        <br />
        ...
        <div>
          ...
          erledigen können. Hierzu zählen vor allem ältere Menschen sowie
          Menschen mit Vorerkrankungen.
          <br />
          Wir möchten Menschen, die altersbedingt oder aus gesundheitlichen
          Gründen einer Risikogruppe angehören, mit Menschen verbinden, die sie
          in dieser Zeit freiwillig unterstützen und so zu ihrem Schutz
          beitragen.
        </div>
        <br />
        <br />
        ...
        <div>
          ...
          halten, indem die Besorungen vor der Wohnungstür abgestellt werden.
          Für die Bezahlung in bar wird das passende Bargeld beispielsweise in
          einem Briefumschlag vor die Wohnungstür gelegt.
          <br />
          Verbindlichkeit – Zugesagte Erledigungen werden nach bestem Wissen und
          ...
          <br />
          Ehrenamtliches & nachbarschaftliches Engagement – Für die erbrachte
          Dienstleistung wird kein Entgelt verlangt. Wir bitten um einen
          sorgsamen Umgang miteinander. Besonders in einer Ausnahmesituation wie
          dieser ist unsere Gesellschaft darauf angewiesen, dass alle
          bestmöglichst zusammenhalten.
        </div>
        <br />
        <br />
      </div>
